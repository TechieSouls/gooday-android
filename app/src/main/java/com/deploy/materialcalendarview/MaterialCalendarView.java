...
import com.deploy.R;
import com.deploy.materialcalendarview.format.ArrayWeekDayFormatter;
import com.deploy.materialcalendarview.format.DateFormatTitleFormatter;
import com.deploy.materialcalendarview.format.DayFormatter;
import com.deploy.materialcalendarview.format.MonthArrayTitleFormatter;
import com.deploy.materialcalendarview.format.TitleFormatter;
import com.deploy.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.deploy.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.deploy.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.deploy.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.deploy.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.deploy.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.deploy.materialcalendarview.format.TitleFormatter)
     */
